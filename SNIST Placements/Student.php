...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Students</a></span></h2>
...
$sql = "select * from student_reg where Status='Confirm'";
// Execute query
...
?>
                ...
                <div align="center"><a href="StudentReg.php"><strong>New Student? Register Here</strong></a>                  </div>
