...
mysql_select_db($database_job, $job);
$query_Recordset2 = "SELECT application_master.ApplicationId, application_master.Status, student_reg.StudentName, student_reg.City, student_reg.Email, application_master.JobId FROM application_master, student_reg WHERE student_reg.StudentId=application_master.StudentId";
...
student_reg.StudentName, student_reg.City, student_reg.Email, student_reg.StudentId,

application_master.JobId
FROM application_master, student_reg
WHERE student_reg.StudentId=application_master.StudentId and application_master.JobId='".$Title."'";
// Execute query
...
?>
                  <tr>
                    ...
                    <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $StudentName;?></strong></div></td>
                    ...
                    <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $Status;?></strong></div></td>
                     <td class="style3"><div align="left" class="style9 style5"><strong></strong><a href="ViewBiodata.php?StudentId=<?php echo $StudentId; ?>&AppId=<?php echo $Id;?>&JobId=<?php echo $Title;?>&Status=<?php echo $Status;?>">View</a></div></td>
                  </tr>
                  <?php
}
