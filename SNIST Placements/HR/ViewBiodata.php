...
mysql_select_db("job", $con);
// Specify the query to execute
$sql = "select * from Student_education where StudentId='".$ID."'";
// Execute query
$result = mysql_query($sql,$con);
// Loop through each records 
...
?>
				...
				{
				?>
                <form id="form1" method="post" action="CallLatter.php?JobId=<?php echo $_GET['JobId'] ;?>&StudentId=<?php echo $_GET['StudentId'] ;?>&AppId=<?php echo $_GET['AppId'] ;?>">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
