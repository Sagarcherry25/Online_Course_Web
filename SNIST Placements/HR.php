...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">HR's Of Different Companies</a></span></h2>
...
$sql = "select * from hr_reg where Status='Confirm'";
// Execute query
...
?>
                ...
                <div align="center"><a href="HRReg.php"><strong>New HR? Register Here</strong></a>
                  </div>
