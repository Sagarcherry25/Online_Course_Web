            ...
            <div class="article">
                ...
                <table width="100%" border="1" bordercolor="#1CB5F1" >
                  <tr>
                    ...
                    <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style9 style5"><strong>Student Name</strong></div></th>
...
$sql = "select FeedbackId,Feedback,FeedbakDate,StudentName from Feedback,student_reg where Feedback.StudentId=student_reg.StudentId";
// Execute query
