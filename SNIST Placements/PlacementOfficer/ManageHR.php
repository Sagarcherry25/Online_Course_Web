...
$sql = "select * from hr_reg where Status='Pending'";
// Execute query
...
?>
                        <tr>
                          ...
                          <td class="style3"><div align="left" class="style9 style5"><strong><a href="DetailHR.php?HRId=<?php echo $Id;?>">Detail</a></strong></div></td>
                        </tr>
                        <?php
}
