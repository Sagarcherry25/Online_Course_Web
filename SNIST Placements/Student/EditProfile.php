...
$sql = "select * from student_reg where StudentId ='".$ID."'  ";
// Execute query
                 ...
                 <!-- <tr>
                  ...
                  <tr>
                    ...
                    <td><span id="sprytextfield2">
                      <label>
                      <input name="txtId" type="text" id="txtId" value="<?php echo $row['StudentId'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
				  <tr>
                    ...
                    <td><span id="sprytextfield2">
                      <label>
                      <input name="txtName" type="text" id="txtName" value="<?php echo $row['StudentName'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
				  ...
				  <tr>
                    ...
                    <td><span id="sprytextfield3">
                      <label>
                      <input name="txtContact" type="text" id="txtContact" value="<?php echo $row['Gender'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
				  <tr>
                    ...
                    <td><span id="sprytextfield3">
                      <label>
                      <input name="txtDate" type="text" id="txtDate" value="<?php echo $row['BirthDate'];?>" />
                      </label>
                    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                  </tr>
